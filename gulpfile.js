...
gulp.task('watch', function(){
    gulp.watch(config.path.html, ['minify-html', 'reload']);
    gulp.watch(config.path.js, ['js', 'reload', 'lint']);
});

gulp.task('default', ['connect', 'minify-html', 'js', 'css', 'images', 'lint', 'open', 'watch']);